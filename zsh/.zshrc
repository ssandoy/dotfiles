...
export JFROG_PASSWORD_64BIT=QW5rb2xtdmVnZW40NCEh
# SSH Activation
eval $(ssh-agent)
ssh-add /home/sander.sandoy/.ssh/id_statnett
...
eval "$(oh-my-posh --init --shell zsh --config '~/.poshthemes/agnoster.omp.json')"
